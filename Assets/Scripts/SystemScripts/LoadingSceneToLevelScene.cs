...
namespace SystemScripts
{
    public class LoadingSceneToLevelScene : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                GameStatusController.IsGameOver = true;  // Set game over status to true.
            }
        ...
        private static IEnumerator LevelScene()
        {
            ...
            GameStatusController.CurrentLevel += 1;  // Increment the current level index for future loading.
        }
        ...
        {
            yield return new WaitForSeconds(2);
            SceneManager.LoadScene(GameStatusController.CurrentLevel - 1);  // Load the current level again.
            GameStatusController.IsDead = false;  // Reset the death status of the player.
        }
